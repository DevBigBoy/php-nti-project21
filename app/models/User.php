...
class User extends config implements operations
{
    ...
    {
        $query = "INSERT INTO `users` (first_name,last_name,email,phone,password,gender,code) VALUES('$this->first_name','$this->last_name','$this->email','$this->phone','$this->password','$this->gender',$this->code)";
